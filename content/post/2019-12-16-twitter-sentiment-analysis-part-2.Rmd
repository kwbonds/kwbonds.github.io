...
```{r part_1_load, echo=FALSE, warning=FALSE, message=FALSE}
load("../../Tweet_image_part_1.RData")
```

```{r load_raw_tweets, echo=FALSE, warning=FALSE, message=FALSE}
raw_tweets <- readRDS("../../raw_tweets.rds")
```


```{r train_tokens_init, echo=FALSE, cache=TRUE, , warning=FALSE, message=FALSE}
...
All of this started to get really heavy for my small, old macbook. So I stoped here for now. 

Update: I started a new job, so I've been focused on that and haven't worked on this. 
