...
train_tokens <- tokens_wordstem(train_tokens, 
                                language = "english")
#train_tokens <- tokens_skipgrams(train_tokens, n = 2, skip = 1)
```
...
train.irlba <- irlba(t(as.matrix(train_tfidf)), nv = 200, maxit = 400)
