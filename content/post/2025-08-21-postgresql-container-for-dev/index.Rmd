...
My past few jobs have had me using a lot of Python, R, Docker, Airflow etc. and not as much time using SQl. As a result my SQL skills are a little rusty. So I decided to create a develpment environment for SQL in order to practice. In this quick post I'll outline how I did that using PostgreSQL in a docker container. I'll go through mounting a volume for persisting data, and creating some tables populated with data. There are plenty of practice environments online, but I want to have certain data tables available to practice analyzing business data specifically.
...
To build and standup the image from a terminal window.
...
Now create an orders table like: 
