...
crude_oil <- left_join(crude_oil, year_stats, by = c("Year" = "Year"))
...
```{r gas_mdl_1, results='hide',fig.keep='all', eval=FALSE}
gas_mdl <- sarima(gas_returns, p = 2, d = 1, q = 0)
gas_mdl
```

```{r gas_mdl_2, results='hide',fig.keep='all', eval=FALSE}
